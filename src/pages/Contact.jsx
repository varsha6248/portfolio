...
export default function Contact() {
  ...
  const quickLinks = [
    { img: githubLogo, title: "GitHub", link: "https://github.com/varsha6248/" },
    { img: linkedinLogo, title: "LinkedIn", link: "https://www.linkedin.com/in/mangalaparthy-varsha-b95252293/" },
    { img: gmailLogo, title: "Email", link: "23211a05h7@bvrit.ac.in" },
  ];
  ...
  return (
    <section className="contact-section">
      ...
      >
        Whether it’s a new project, a collaboration, or just to say hi — I'd like to hear from you!
      </motion.p>
